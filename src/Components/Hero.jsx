      ...
      <div className="bg-gradient-to-b from-blue-500 to-blue-800 rounded-md m-3 p-2">
        ...
        <section className="text-white body-font">
            <div className="container mx-auto flex lg:px-5 md:px-3 sm:px-2 py-5 md:flex-row flex-col items-center">
                ...
                <img className="object-center object-cover rounded-md sha" alt="hero" src="https://img.freepik.com/premium-photo/large-group-cats-dogs-looking-camera-blue-background_756748-70498.jpg"/>
                </div>
            </div>
