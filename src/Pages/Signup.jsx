  ...
  return (
    ...
    <div className='max-w-[25em] rounded-sm bg-gradient-to-b from-blue-600 to-blue-900 items-center justify-center align-middle mt-10 mx-auto p-2 sha'>
        ...
        <form className='m-2 px-3' onSubmit={onsubmithandle}>
            ...
            <input type='name' className='w-full h-10 text-center text-green-600 rounded-md' placeholder='example@gmail.com' onChange={(e) => setemail(e.target.value)} required/>
            <h2 className='text-xl font-thin my-3 text-white'>Username :</h2>
            <input type='name' className='w-full h-10 text-green-600 text-center rounded-md' placeholder='User Surname' onChange={(e) => setname(e.target.value)} required/>
            <h2 className='text-xl font-thin my-3 text-white'>Password :</h2>
            <div className='flex'>
            <input type= {(pass) ? 'text' : 'password'} className='w-full text-green-600 h-10 text-center rounded-md' placeholder='Enter Password' onChange={(e) => setpassw(e.target.value)} required/>
            {(!pass) ? 
            ...
            <input type='password' className='w-full text-green-600 focus:ring-green-600 focus:ring-0 focus:outline-none h-10 text-center rounded-md' placeholder='Confirm Password' required/>
    ...
    <div className='max-w-[25em] rounded-md w-80 bg-gradient-to-b from-blue-600 to-blue-900 items-center justify-center lg:m-auto sm:m-0 align-middle mt-10 mx-auto p-2 sha h-80'>
        ...
        <button className='bg-blue-700 mx-auto text-white transition-all duration-300 hover:bg-blue-600 cursor-pointer m-2 px-2 rounded-md text-center flex justify-center'>
