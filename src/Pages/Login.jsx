  ...
  return (
    ...
    <div className='max-w-[25em] rounded-sm bg-gradient-to-b from-blue-600 to-blue-900 items-center justify-center align-middle mt-10 mx-auto p-2'>
        ...
        <form className='m-2 px-3'>
            ...
            <input type='name' className='w-full h-10 text-center rounded-md' placeholder='example@gmail.com' required/>
            <h2 className='text-xl font-thin my-3 text-white'>Password :</h2>
            <div className='flex'>
            <input type= {(pass) ? 'text' : 'password'} className='w-full h-10 text-center rounded-md' placeholder='Enter Password' required/>
            {(!pass) ? 
